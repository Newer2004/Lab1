...
background_sound = pygame.mixer.Sound("lab8/resources/background.wav")
crush_sound = pygame.mixer.Sound("lab8/resources/crash.wav")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 5
        self.image = pygame.image.load('lab8/resources/Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.speed = 7
        self.image = pygame.image.load('lab8/resources/Player.png')
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        global running
        self.image = pygame.image.load("lab8/resources/cent.png")
        self.speed = 7
