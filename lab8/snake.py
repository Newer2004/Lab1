...
BLOCK_SIZE = 20
background_sound = pygame.mixer.Sound("lab8/resources/Snake Game - Theme Song.mp3")
background_sound = pygame.mixer.music.load("lab8/resources/Snake Game - Theme Song.mp3")
eat_sound = pygame.mixer.Sound("lab8/resources/snake-hissing-6092.mp3")
