...
background = pygame.image.load("lab9/racer/images/Street.png")
 
DISPLAYSURF = pygame.display.set_mode((400,600))
DISPLAYSURF.fill(WHITE)
pygame.display.set_caption("Racer")
#setting up background music
pygame.mixer.music.load("lab9/racer/sounds/background.wav")
...
class Mega_coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("lab9/racer/images/Coin.png"),(60,60))
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("lab9/racer/images/Coin.png"),(30,30))
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(20, SCREEN_WIDTH - 20), 0)
    def rem(self):
        self.rect.top = 0
