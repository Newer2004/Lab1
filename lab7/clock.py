...
mickeyclock = pygame.image.load("lab7/images/background.jpg")
minure_arrow = pygame.image.load("lab7/images/min.png")
second_arrow = pygame.image.load("lab7/images/sec.png")
