...
BLOCK_SIZE = 20
background_sound = pygame.mixer.Sound("lab10/materials/Snake Game - Theme Song.mp3")
background_sound = pygame.mixer.music.load("lab10/materials/Snake Game - Theme Song.mp3")
eat_sound = pygame.mixer.Sound("lab10/materials/snake-hissing-6092.mp3")
